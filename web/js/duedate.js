var dueDateCalculator = function() {
  ...
  calculatorImpl = function (startDate, millis, workTimeSchedule) {
  ...
  workTimeSchedule = function() {
    ...
    var START = 9, END = 17, schedule = {
      ...
      'startOfNextPeriod' : function() {
        var DAYS_IN_MILLISEC = 24 * HOURS_IN_MILLISEC,
  ...
  dueDateCalc = function(startDate, hours, schedule) {
    return calculatorImpl(startDate, hours * HOURS_IN_MILLISEC, schedule || workTimeSchedule);
  };
  
  dueDateCalc.workTimeSchedule = workTimeSchedule;
  return dueDateCalc;
}();
